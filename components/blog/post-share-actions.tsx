...
export default function PostShareActions({ title }: PostShareActionsProps) {
  ...
  return (
    <div className="share-bar">
      <span className="share-bar__label">Share this article</span>
      ...
      <div className="share-bar__buttons">
        ...
        >
          <svg className="share-btn__icon" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        >
          {copied ? (
            <Check className="share-btn__icon" aria-hidden="true" />
          ) : (
            <Link2 className="share-btn__icon" aria-hidden="true" />
          )}
