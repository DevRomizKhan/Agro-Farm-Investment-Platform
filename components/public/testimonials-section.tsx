...
const testimonials = [
  {
    ...
    content: 'I have been investing with Amanah Farm for 2 years. Returns are consistent every month. The dashboard makes it easy to track everything. Highly recommended!',
    rating: 5,
    invested: '৳5,00,000',
  },
  {
